namespace (this should already be included when the file is made)
 {
 public class (this should already be included when the file is created, just change internal to public.)
 Copy code below(including brackets) :
 {
